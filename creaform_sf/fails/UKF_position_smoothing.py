...
from numpy import array, arange, asarray, sqrt, eye, diag, linalg, ones, transpose, subtract, pi, sin, matmul, vstack, hstack, loadtxt, mean, linspace, zeros
...
class myUKF:
    ...
    def create_UKF(self):
        ...
        self.UKF.P *= 50
        z_std = 0.00001**2.; self.UKF.R = diag([z_std, z_std, z_std])
